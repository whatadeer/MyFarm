# Builds myfarm.cia without installing devkitPro on the host.
#
#   podman build -t myfarm-builder -f Containerfile .
#   podman run --rm -v ${PWD}:/project myfarm-builder make cia
#
# devkitpro/devkitarm already ships devkitARM, libctru, and citro2d/citro3d -
# everything this project links against (no networking, so none of the
# curl/mbedtls/jansson/zlib ports are needed here).
#
