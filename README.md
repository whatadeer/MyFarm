...
- **Skills**: unbounded RuneScape-style curve (~18%/level,
  `source/core/skills.cpp`). Levels gate node tiers (tier 1 at Logging 5,
  tier 2 at 12, etc. - see `balance.h`), grow your herd cap, and add yield
  bonuses every 8 levels.
